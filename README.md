**NOTE**: The .env file is used to store the API_URL. **Please ensure that the .env file is added and that the according URL for the API is included in the .env file.**
